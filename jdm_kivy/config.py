...
class JDMConfig:
    ...
    @staticmethod
    def __get_original_config(name: str):
        return JDMConfig.__original_config.get(name)
    ...
    @staticmethod
    def reset(name: str):
        JDMConfig.__change_config(name, JDMConfig.__get_original_config(name))
    ...
    def set(name: str, value: any):
        JDMConfig.__change_config(name, value)
